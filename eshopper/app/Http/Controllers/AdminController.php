    ...
    public function updateCurrentPassword(Request $request){
 	...
 	if(Hash::check($data['current_pwd'],Auth::guard('admin')->user()->password)){
    		if($data['new_pwd']==$data['confirm_pwd']){
    		      ...
    		      Session::flash('error_message','Your new password and confirm password are not match');
	...
	Session::put('page','update-admin-details');
    	if($request->isMethod('post')){
    		...
    		$customMessages = [
    			...
    			'admin_name.max' => 'Valid name must has max 25 character',
    		...
    		if($request->hasFile('admin_image')){
    			...
    			if($image_tmp->isValid()){
    				...
    				$imagePath = '/var/www/html/eshopper/public/backend/images/admin_images/'.$imageName;
