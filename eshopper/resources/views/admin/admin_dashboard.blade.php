        ...
        <div class="widget-box">
          ...
          <div class="widget-content tab-content">
            <div id="tab1" class="tab-pane active">
              ...
              <img src="{{asset('backend/images/demo/demo-image1.jpg')}}" alt="demo-image"/></div>
            <div id="tab2" class="tab-pane"> <img src="{{asset('backend/images/demo/demo-image2.jpg')}}" alt="demo-image"/>
              <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.</p>
            </div>
            <div id="tab3" class="tab-pane">
              <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment. </p>
              <img src="{{asset('backend/images/demo/demo-image3.jpg')}}" alt="demo-image"/></div>
          </div>
        </div>
      </div>
    </div>
