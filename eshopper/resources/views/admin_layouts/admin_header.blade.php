  ...
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome User</span><b class="caret"></b></a>
  	...
  	@else
  		<?php $active = ""; ?>
  	@endif
        <li class="{{$active}}"><a href="{{url('/admin/update-admin-details')}}"><i class="icon-user"></i>Edit My Profile</a></li>
        <li class="divider"></li>
  	...
  	@else
  		<?php $active = ""; ?>
  	@endif
        <li class="{{$active}}"><a href="{{url('/admin/settings')}}"><i class="icon-check"></i>Change Password</a></li>
        <li class="divider"></li>
